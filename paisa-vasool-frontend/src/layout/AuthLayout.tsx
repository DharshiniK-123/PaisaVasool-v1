  ...
  return (
    <div className="noise-overlay" style={{ minHeight: '100vh', background: 'var(--color-bg)', display: 'flex' }}>
      ...
      <aside className="auth-layout-left">
        ...
        {/* Layered background radial atmosphere */}
        <div style={{
        ...
        <div style={{
          ...
          <div style={{
            width: '100%',
            background: 'linear-gradient(150deg, rgba(52,211,153,0.045) 0%, rgba(52,211,153,0.02) 100%)',
            border: '1px solid rgba(52,211,153,0.13)',
            borderRadius: 14,
            ...
            <span style={{ color: 'var(--color-accent)', letterSpacing: '0.2em', fontSize: '0.56rem' }}>
              ★★★★★
            </span>
            <p style={{ fontSize: '0.795rem', color: 'var(--color-muted)', fontStyle: 'italic', lineHeight: 1.7 }}>
              "Finally a finance app that doesn't feel like a spreadsheet."
            </p>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              ...
              <p style={{ fontSize: '0.72rem', color: 'var(--color-text)', fontWeight: 500 }}>
                Priya M.{' '}
                <span style={{ color: 'var(--color-muted)', fontWeight: 400 }}>· Mumbai</span>
              </p>
            </div>
          </div>
