...
from src.core.services.matching_service import run_matching_for_payment  # ← add this import
...
async def _process_dataframe(df: pd.DataFrame, document_type: str, document_id: int, db: AsyncSession) -> int:
    # ✅ One LLM call for the entire dataframe
    df_text = df.to_string(index=False)
    all_data = await run_extraction_batch(df_text, document_type)  # returns list of dicts
